...
|Должность                         |Отображение имени списка воспроизведения                                                               |
|Изображение                         |Относительный URL-адрес (от CDN) к изображению для визуализации списка воспроизведения                              |                      
...
|Source                        |Из массива исходных данных, не используемых специально в UX, кроме пользовательских данных, добавленных пользователем, отмечено как "Tenant", а область администрирования UX не разрешает редактирование ничего не отмеченного "Tenant".                                              |
...
|Source                        |Отображение имени категории/подкатегории                                                  |
|StatusTagId                   |Тег связанного состояния                                                                      |
|StatusNote                    |Заметки о контенте, отображаемом администраторам.                                           |

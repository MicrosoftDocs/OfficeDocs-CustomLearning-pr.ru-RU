...
С помощью путей обучения работа с настраиваемыми списками воспроизведения зависит от того, как подготовлен сайт путей обучения. 
...
**Открытие актива**
1. Выберите только что созданный ресурс и нажмите кнопку **Открыть**.  
...
1.  В **меню "** пути для обучения" выберите пункт **обучающие пути Администрирование**. 
2.  Выберите настраиваемый список воспроизведения. Настраиваемый список воспроизведения определяется значком "люди" с галочкой, как показано в следующем примере.
...
5. Выберите **сохранить сведения**.
 Обратите внимание на то, что доступные языки будут зависеть от поддерживаемых языков, выбранных для сайта. Чтобы добавить дополнительные языки, необходимо добавить на сайт дополнительные Поддерживаемые языки.   

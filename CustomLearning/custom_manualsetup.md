...
Теперь настройка завершена. Чтобы узнать больше о том, как настроить пользовательский сайт обучения и веб-часть для вашей среды, ознакомьтесь [со статьЕй Настройка обучающих интерфейсов](custom_overview.md).
